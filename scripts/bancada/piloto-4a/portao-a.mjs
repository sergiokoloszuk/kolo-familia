...
w(`PORTÃO A · 8 casos funcionais · pipeline REAL da web`);
...
writeFileSync(`${process.cwd()}/docs/bancada/piloto-4a-portao-a-2026-08-10.txt`, out.join("\n"), "utf8");
console.log("\npronto → docs/bancada/piloto-4a-portao-a-2026-08-10.txt");

/**
 * Dados de seed dos prompts da IA (`ai_prompts` table). Fonte da verdade.
 *
 * Espelhado em `scripts/seed-ai-prompts.mjs` pra rodar localmente também.
 * Ao mudar QUALQUER prompt aqui, atualize o .mjs também (ou rode o endpoint
 * `/api/admin/seed-ai-prompts` em produção, que reusa estes dados).
 */

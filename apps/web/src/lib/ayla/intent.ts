...
- Na dúvida entre "organizacao" e "plano": se o que trava é a PASSAGEM entre atividades, ou a criança não saber o que vem depois, é organizacao. Se é o comportamento em si (comida, sono, agressão, escola), é plano.

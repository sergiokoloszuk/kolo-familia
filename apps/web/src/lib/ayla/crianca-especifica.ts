...
// A leitura do campo do nome (regex pura) mora em `crianca-nome.ts` — este
// módulo puxa o cliente da Anthropic, e componentes de cliente precisam das
// funções puras sem arrastar o SDK junto. Reexportado pra não quebrar quem já
// importava daqui.
export {
  nomeUsavelCrianca,
  motivoNomeNaoNome,

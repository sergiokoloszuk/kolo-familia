...
COMO ESTA CRIANÇA RECEBE MELHOR. Não existe "estilo de aprendizagem" fixo, e não classifique ninguém. Mas repare, pragmaticamente, no que funciona com ela: fala ou menos fala · frases curtas · demonstrar · imagem · sequência visual · gesto · objeto concreto · movimento · fazer junto · modelar · repetir · antecipar · história · brincadeira · o interesse dela. Quando não souber, proponha um teste pequeno — "vamos experimentar falar menos e mostrar?", "e se a sequência estiver em imagens?", "fazer junto primeiro e depois ir soltando" — e APRENDA COM A RESPOSTA DA CRIANÇA, que é o que vale mais que qualquer teoria.

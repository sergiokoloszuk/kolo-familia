...
QUANDO O GATILHO É UMA HABILIDADE QUE FALTA, O ALVO É A HABILIDADE. Trabalhar só o que o ADULTO faz alivia o momento e deixa a criança sem saída — e o problema volta na semana seguinte. Se a criança evita a escola porque não sabe o que fazer quando a amiga diz não; se morde porque não consegue pedir; se grita porque não sabe perder — a conduta do adulto é o paliativo, e a habilidade é o alvo. Dê à criança O QUE FAZER DA PRÓXIMA VEZ, em duas ou três opções que ELA possa escolher, e ensaie num momento calmo, nunca no meio da dificuldade.

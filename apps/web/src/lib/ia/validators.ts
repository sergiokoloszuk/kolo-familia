 ...
 *
 * ⚠️ AUDITORIA DA CLASSE INTEIRA (01/08/2026). A lista original era de PALAVRAS
 * clínicas, e uma lista de palavras erra nos dois sentidos — sempre. Não era um
 * problema da palavra "diagnóstico": era do método.
 *
 * O que ela BARRAVA e não devia (respostas seguras, todas reais ou plausíveis):
 ...
 *   - "posso te dar uma receita simples de panqueca" → num produto que fala de
 *     seletividade alimentar o dia inteiro, "receita" é vocabulário do cotidiano
 *
 ...
 * detectores de ATO — `validateAntiDiagnostico` (conclusão diagnóstica) e
 * `validateAntiClinico` (prescrever, concluir causa, graduar, minimizar,
 * explicar sintoma físico pela neurodivergência).
 *

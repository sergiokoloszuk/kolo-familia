...
const CARDS: Card[] = [
  ...
  },
  {
    ...
    desc: "A sequência do dia em cartões (ou lista) — previsibilidade e autonomia. Monte a semana toda, um dia específico (dia do dentista, do parque…) ou peça pra Kolo montar.",
    icone: CalendarDays,
    href: "/ludico/rotinas",
